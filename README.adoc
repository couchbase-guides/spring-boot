...
This guide walks you through the process of using http://projects.spring.io/spring-boot/[Spring Boot] to build an application that stores data in and retrieves it from http://www.couchbase.com/[Couchbase], a document-based database.
:imagesdir: images
